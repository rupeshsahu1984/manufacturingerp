<?php
// Simple Web Installer for PRODX
...
if ($_POST && $step == 2) {
    ...
    try {
        ...
        $mysqli->query("CREATE TABLE users (
            ...
            role ENUM('super_admin', 'reception', 'purchase', 'sales', 'production', 'finance', 'gate_entry', 'hrm') DEFAULT 'operator',
        ...
        $mysqli->query("CREATE TABLE company_profile (
            id INT PRIMARY KEY AUTO_INCREMENT,
        ...
        $mysqli->query("INSERT INTO users (username, email, password, full_name, role) VALUES 
            ('admin', 'admin@prodx.com', '$admin_password', 'Super Administrator', 'super_admin')");
...
<body>
    ...
    // Create a simple redirect to the CodeIgniter login
    $login_content = '<?php
// Redirect to CodeIgniter login
    ...
    <div class="container">
        <div class="installer-card p-4">
            ...
            <div class="text-center mb-4">
                ...
                <h2 class="fw-bold">PRODX</h2>
        <p class="text-muted">Smarter Control for Modern Manufacturing</p>
                  </div>
            ...
            <div class="text-center">
                ...
                <form method="post" class="text-start">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-database me-2"></i>Install PRODX
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="text-center">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Click the button below to access your PRODX system</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <a href="index.php" class="btn btn-success btn-lg me-3">
                        <i class="fas fa-rocket me-2"></i>Launch PRODX
                    </a>
