...
<!-- Header -->
<div class="header">
    <h1><i class="fas fa-users me-3"></i>Employee Master</h1>
    <div class="header-actions">
        <a href="<?= base_url('employee/create') ?>" class="btn btn-primary">
            <i class="fas fa-plus"></i> Add Employee
        </a>
        <a href="<?= base_url('employee/export') ?>" class="btn btn-outline-success ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="<?= base_url('employee/show/' . $employee['id']) ?>" 
