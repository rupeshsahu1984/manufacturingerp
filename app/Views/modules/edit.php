        ...
        <div class="content">
            <div class="content-header">
                <div>
                    ...
                    <p class="text-muted mb-0">Edit <?= strtolower($title) ?></p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    $itemCode = $item['code']
                        ...
                        ?? '';
                    ?>
                    <form data-validate action="<?= base_url($moduleName . '/update/' . (isset($item['id']) ? $item['id'] : 1)) ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control" id="name" name="name" value="<?= esc($itemName) ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="code" class="form-label">Code</label>
                                <input type="text" class="form-control" id="code" name="code" value="<?= esc($itemCode) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3"><?= isset($item['description']) ? $item['description'] : '' ?></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
