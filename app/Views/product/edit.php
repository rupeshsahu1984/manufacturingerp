...
<?= $this->section('content') ?>
            ...
            <div class="content-card">
                <div class="card-header">
                    <h5><i class="fas fa-box me-2"></i>Edit Material Information</h5>
                </div>
                ...
                <div class="card-body p-3">
                    ...
                    <form data-validate action="<?= base_url('product/update/' . $product['id']) ?>" method="POST" class="needs-validation" novalidate>
                        <div class="row">
                            <!-- Basic Information -->
                            <div class="col-md-8">
                                    ...
                                    <div class="card-body py-3">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="product_code" class="form-label fw-bold">Material Code</label>
                                                <input type="text" 
                                                       class="form-control" 
                                                       id="product_code" 
                                                       value="<?= $product['product_code'] ?>" 
                                                       readonly>
                                                <div class="form-text small">Material code cannot be changed</div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select <?= session('errors.material_type') ? 'is-invalid' : '' ?>" 
                                                    ...
                                                    <option value="raw_material" <?= old('material_type', $product['material_type']) == 'raw_material' ? 'selected' : '' ?>>Raw Material</option>
                                                    <option value="packaging" <?= old('material_type', $product['material_type']) == 'packaging' ? 'selected' : '' ?>>Packaging Material</option>
                                                    <option value="finished_goods" <?= old('material_type', $product['material_type']) == 'finished_goods' ? 'selected' : '' ?>>Finished Goods</option>
                                                    <option value="waste" <?= old('material_type', $product['material_type']) == 'waste' ? 'selected' : '' ?>>Waste Material</option>
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select <?= session('errors.unit') ? 'is-invalid' : '' ?>" 
                                                    ...
                                                    <option value="mm" <?= old('unit', $product['unit']) == 'mm' ? 'selected' : '' ?>>Millimeter (mm)</option>
                                                    ...
                                                    <option value="sheet" <?= old('unit', $product['unit']) == 'sheet' ? 'selected' : '' ?>>Sheet</option>
                                                </select>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" 
                                                           ...
                                                           id="gst_rate" 
                                                           name="gst_rate" 
                                                           value="<?= old('gst_rate', isset($product['gst_rate']) ? $product['gst_rate'] : '18.00') ?>" 
                                                           min="0" 
                                                           max="100" 
                                                           step="0.01" 
                                                           placeholder="18.00"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" 
                                                           ...
                                                           id="cgst_rate" 
                                                           name="cgst_rate" 
                                                           value="<?= old('cgst_rate', isset($product['cgst_rate']) ? $product['cgst_rate'] : '9.00') ?>" 
                                                           min="0" 
                                                           max="100" 
                                                           step="0.01" 
                                                           placeholder="9.00"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" 
                                                           ...
                                                           id="sgst_rate" 
                                                           name="sgst_rate" 
                                                           value="<?= old('sgst_rate', isset($product['sgst_rate']) ? $product['sgst_rate'] : '9.00') ?>" 
                                                           min="0" 
                                                           max="100" 
                                                           step="0.01" 
                                                           placeholder="9.00"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" 
                                                           ...
                                                           id="igst_rate" 
                                                           name="igst_rate" 
                                                           value="<?= old('igst_rate', isset($product['igst_rate']) ? $product['igst_rate'] : '18.00') ?>" 
                                                           min="0" 
                                                           max="100" 
                                                           step="0.01" 
                                                           placeholder="18.00"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" 
                                                           ...
                                                           value="<?= old('waste_percentage', $product['waste_percentage']) ?>" 
                                                           min="0" 
                                                           max="100" 
                                                           step="0.1" 
                                                           placeholder="0.0">
                                            ...
                                            <div class="col-md-6 mb-3 d-flex align-items-end">
                                                <div class="form-check">
                                                    <input class="form-check-input" 
                                                           ...
                                                           name="is_recyclable" 
                                                           value="1" 
                                                           <?= old('is_recyclable', $product['is_recyclable']) ? 'checked' : '' ?>>
                                    ...
                                    <div class="card-body py-3">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" 
                                                      ...
                                                      name="description" 
                                                      rows="12" 
                                                      placeholder="Enter detailed material description, specifications, usage notes, or any additional information..."><?= old('description', $product['description']) ?></textarea>
                                        </div>
