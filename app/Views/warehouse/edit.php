...
<!-- Header -->
<div class="header">
    <h1><i class="fas fa-edit me-3"></i>Edit Warehouse</h1>
...
<div class="content-card">
    ...
    <div class="card-body">
        <form method="POST" action="<?= base_url('warehouse/update/' . $warehouse['id']) ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="location" name="location" rows="3" 
                          placeholder="Enter warehouse location details..." required><?= old('location', $warehouse['location']) ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="form-text">Set the status for this warehouse</div>
                    </div>
                </div>
            </div>
