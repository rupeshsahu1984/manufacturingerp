    ...
    <div class="card-body">
        <form method="POST" action="<?= base_url('category/update/' . $category['id']) ?>">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="category_type" name="category_type" required>
                            ...
                            <option value="raw_material" <?= (old('category_type', $category['category_type']) == 'raw_material') ? 'selected' : '' ?>>Raw Material</option>
                            <option value="packaging" <?= (old('category_type', $category['category_type']) == 'packaging') ? 'selected' : '' ?>>Packaging</option>
                            <option value="finished_goods" <?= (old('category_type', $category['category_type']) == 'finished_goods') ? 'selected' : '' ?>>Finished Goods</option>
                            <option value="waste" <?= (old('category_type', $category['category_type']) == 'waste') ? 'selected' : '' ?>>Waste</option>
                        </select>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Set the status for this category</div>
            </div>
