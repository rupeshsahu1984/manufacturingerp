...
<!-- Header -->
<div class="header">
    <h1><i class="fas fa-edit me-3"></i>Edit Department</h1>
    <div class="header-actions">
        <a href="<?= base_url('hr/departments') ?>" class="btn btn-secondary">
...
<div class="content-card">
    ...
    <div class="card-body">
        <form method="POST" action="<?= base_url('hr/department/update/' . $department['id']) ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Set the status for this department</div>
            </div>
