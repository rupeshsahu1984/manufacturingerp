...
<div class="header">
    <h1><i class="fas fa-money-check-alt me-3"></i>Edit Customer Payment</h1>
    <div class="header-actions">
        <a href="<?= base_url('customer-payment') ?>" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left"></i> Back to List
        </a>
        <a href="<?= base_url('customer-payment/show/' . $payment['id']) ?>" class="btn btn-info">
    ...
    <div class="col-lg-8">
        <div class="content-card">
            <div class="card-header">
                <h5><i class="fas fa-edit me-2"></i>Edit Payment Details</h5>
            </div>
            <div class="card-body">
                <form id="paymentForm" action="<?= base_url('customer-payment/update/' . $payment['id']) ?>" method="POST">
                    <?= csrf_field() ?>
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Payment Number</label>
                            <input type="text" class="form-control" name="payment_number" value="<?= esc($payment['payment_number']) ?>" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold text-danger">* Payment Date</label>
                            <input type="date" class="form-control" id="paymentDate" name="payment_date" value="<?= esc($payment['payment_date']) ?>" required>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="paymentAmount" name="payment_amount" 
                                       ...
                                       value="<?= esc($payment['payment_amount']) ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="reference_number" 
                               ...
                               value="<?= esc($payment['reference_number'] ?? '') ?>">
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Notes</label>
                        <textarea class="form-control" name="notes" rows="3" 
                                  placeholder="Any additional information..."><?= esc($payment['notes'] ?? '') ?></textarea>
                    </div>

                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <strong>Warning:</strong> Editing this payment will update the corresponding invoice amounts. Please verify all details before saving.
                    </div>

                    <div class="text-end mt-4">
                        <a href="<?= base_url('customer-payment/show/' . $payment['id']) ?>" class="btn btn-outline-secondary me-2">
