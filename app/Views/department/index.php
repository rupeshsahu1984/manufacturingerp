...
<div class="header">
    ...
    <div class="header-actions">
        ...
        <a href="<?= base_url('department/export') ?>" class="btn btn-outline-success ms-2">
...
<div class="content-card mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="<?= base_url('department') ?>">
            <div class="row">
                <div class="col-md-8">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="<?= base_url('department/show/' . $department['id']) ?>" 
                                           class="btn btn-sm btn-outline-primary" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?= base_url('department/edit/' . $department['id']) ?>" 
